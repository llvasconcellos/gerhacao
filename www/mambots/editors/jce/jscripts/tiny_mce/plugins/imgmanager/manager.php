			...
			<div id="general_panel" class="panel current">
				<fieldset>
						...
						<tr>
							...
							<td colspan="3"><select name="align" id="align" onChange="changeAppearance();updateStyle();">
					...
					<table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
	                        ...
	                        <td><select id="classlist" name="classlist" class="mceEditableSelect">
									...
									<option value="jce_tooltip" selected>JCE Tooltip</option>
								 </select>
						    </td>
						</tr>
						<tr>
    ...
    <table class="properties" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="5" style="vertical-align:top">
				...
				<?php }?>
				<div id="hlpIcon" style="display: inline;"><a href="javascript:void(0)" onClick="javascript: openHelp('imgmanager');" class="toolbar"><img src="<?php echo  $jce->getLibImg('help.gif');?>" border="0" alt="<?php echo $jce->translate('help');?>" width="20" height="20" title="<?php echo $jce->translate('help');?>" /></a></div>
			</td>
		</tr>
		<tr>
